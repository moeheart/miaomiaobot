...
def handletest():
    ...
    urllib.request.urlopen('http://127.0.0.1:5000/openqq/send_group_message?id=%d&content=%s&async=1'%(id,urllib.parse.quote(message)))
...
if __name__ == '__main__':
    ...
    app.info = {
      ...
      '【赤繁】妈耶饭里有砂':{'owner':['眼眸印温柔','陈必过'], 'help':1, 'smoke':0, 'base': '【赤繁】妈耶饭里有砂'},
      ...
      '君不弃大型相亲现场':{'owner':['楚🐳',], 'help':1, 'smoke':0, 'base': '君不弃大型相亲现场'},
      ...
      '天天见玄晶':{'owner':['Candy',], 'help':1, 'smoke':0, 'base': '天天见玄晶'},
      '菜刀队':{'owner':['闵松月','静候轮回'], 'help':1, 'smoke':0, 'base': '菜刀队'},
