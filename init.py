...
type2 = ["丐帮","藏剑","霸刀","剑纯","苍云","丐帮","藏剑","霸刀","剑纯","惊羽","大师","冰心","花间","气纯","毒经","大师","冰心","花间","气纯","奶秀","明尊","铁牢","奶花","奶歌","奶毒"]
...
for i in range(len(sch)):
    ...
    for j in range(1,26):
        ...
        elif name[i] in ["千雷","千雷殿"]:
            sql = """INSERT INTO playerinfo VALUES ('%s', %d, '%s', '', '')"""%(sch[i],j,type2[j-1])
        else:
